...
<body class="dark:bg-slate-900 dark:text-white">
    ...
    <div class="mb-8 text-center">
        <button x-cloak x-on:click="darkMode = !darkMode;">
            <span x-show="!darkMode" class="w-8 h-8 p-2 ml-3 text-slate-700 transition bg-slate-100 rounded-md cursor-pointer hover:bg-slate-200">Dark</span>
            <span x-show="darkMode" class="w-8 h-8 p-2 ml-3 text-slate-100 transition bg-slate-700 rounded-md cursor-pointer dark:hover:bg-slate-600">Light</span>
        </button>
    </div>
