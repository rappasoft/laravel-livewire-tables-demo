...
<body class="dark:bg-gray-900 dark:text-white">
    ...
    <div class="pb-6 mx-auto space-y-10 w-full px-8">
        ...
        <div wire:key="usersTable">
            <livewire:users-table myParam="Test" filterLayout="{{ $displayStyle }}"/>
        </div>
        <div wire:key="newsTable">
            <livewire:news-table myParam="Test" filterLayout="{{ $displayStyle }}"/>
        </div>
